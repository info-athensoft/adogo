...
<body class="boxed bg-cover"
	style="background-image: url(/img/backgrounds/s7.jpg)">
					...
					<div class="row">
						...
						<div class="col-md-2 col-md-offset-7">
							<div class="product-view pull-right">
								<a class="fa fa-th-large active" href="#"></a> <a
									class="fa fa-list" href="/"></a>
							</div>
						</div>
					</div>
							...
							<div class="col-md-4">
								<div class="product-thumb">
									<header class="product-header">
										<img src="${booth.logoCoverUrl}" alt="${booth.bizName}"
											title="${booth.bizName}" />
									</header>
