...
<body class="boxed bg-cover" style="background-image: url(/img/backgrounds/s7.jpg)">
	...
	<div class="container">
            <div class="row row-wrap">
                <div class="col-md-9">
                	<div><h3>ADOGO平台内部测试活动常见问题解答</h3>	</div>
                	<br/>               	
                	<div><h5 class="panel-title">1. 关于内测</h5><br/></div>
                	
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-1">1.1 什么是ADOGO平台内测?</a></h4>
                            </div>
                            <div class="panel-collapse collapse in" id="collapse-1">
                                <div class="panel-body">
                                    <p>ADOGO平台内测是面向商家或者广告主的进驻测试，简称内测。首轮内测截止到 2016年6月30日。</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-3">1.2 内测的主要目的是什么？</a></h4>
                            </div>
                            <div class="panel-collapse collapse" id="collapse-3">
                                <div class="panel-body">
                                    <p>内测的目的是集结一批有强烈品牌形象意识、积极向上并认同抱团共赢理念的企业家、生意人、专业个人等，体验广告平台的基本展示与推广功能、评估效果、即时反馈并提出建设性的宝贵意见和建议，使得平台的设计和发展完全符合市场的口味和需要。借此形成开放式成长模式与氛围，人人可以参与建设。</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-2">1.3 内测的主要内容是什么？</a></h4>
                            </div>
                            <div class="panel-collapse collapse" id="collapse-2">
                                <div class="panel-body">
                                    <p>平台为广告主建立一个在线形象展位，按行业类别和进驻属性分别放置在首页或分类页。该展位可以作为广告主在平台的形象标识、亦是广告主所有在线展示介质的统一入口。其在线展示介质通常是：网站、登陆页、社交媒体主页、网店、其它个人主页等。</p>
                                </div>
                            </div>
                        </div>
