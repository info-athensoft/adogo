...
<c:set var="title_faq" value="ADOGO品牌与广告推广平台  - 内部测试活动常见问题解答"/>
<c:set var="sec1" value="1. 关于第二轮公测"/>

<c:set var="quest1_1" value="1.1 什么是ADOGO平台第二轮公测?"/>
<c:set var="answer1_1" value="ADOGO平台第二轮公测是面向广告主的进驻和广大网友和用户的测试，简称公测。第二轮公测于2016年7月1日开始，截止到 2016年9月30日。"/>

<c:set var="quest1_2" value="1.2 公测的主要目的是什么？"/>
<c:set var="answer1_2" value="公测的目的是集结一批有强烈品牌形象意识、积极向上并认同抱团共赢理念的企业家、生意人、专业个人等，体验广告平台的基本展示与推广功能、评估效果、即时反馈并提出建设性的宝贵意见和建议，使得平台的设计和发展完全符合市场的口味和需要。借此形成开放式成长模式与氛围，人人可以参与建设。公测的第二个目的是广泛地集结用户和网友，让大家能不费力气就能找到满足各种需要的放心商家，或当下或远期都能够用得着。"/>

<c:set var="quest1_3" value="1.3 公测的主要内容是什么？"/>
<c:set var="answer1_3" value="平台为广告主建立一个在线形象展位，按行业类别和进驻属性分别放置在首页或分类页。该展位可以作为广告主在平台的形象标识、亦是广告主所有在线展示介质的统一入口。其在线展示介质通常是：网站、登陆页、社交媒体主页、网店、其它个人主页等。平台亦为广大用户节省大量搜索信息的时间，并提高精准度。"/>

<c:set var="quest1_4" value="1.4 我是否能参加公测？"/>
<c:set var="answer1_4" value="只要您满足是注册公司、长期稳定地提供服务或产品的个人、想长期推广自己品牌任何一项，均有资格申请广告主的公测项目。广大用户和网友直接参加注册测试。"/>

<c:set var="quest1_5" value="1.5 如何获取公测资格？"/>
<c:set var="answer1_5" value="有两种方式可获取内测资格。第一、我们直接联系您并发出邀请，您同意后可以直接获取公测资格。第二、在微信群或者朋友圈看见公共邀请广告后，通过微信群，微信好友联系我们我们亦可获得公测资格。广大用户和网友直接参加注册测试。"/>

<c:set var="quest1_6" value="1.6 参加公测有哪些好处？"/>
<c:set var="answer1_6" value="可以率先拥有广告展位，提早曝光积聚人气，免费在线推广评估与咨询，获取一定的网络推广策划帮助。"/>

<c:set var="quest1_7" value="1.7 广告展位收费吗？"/>
<c:set var="answer1_7" value="公测期间发放的广告展位，是免费的，并且可以永久保留。"/>

<c:set var="sec2" value="2. 一般问题"/>
<c:set var="quest2_1" value="2.1 什么是浏览者?"/>
<c:set var="answer2_1" value="浏览者(Visitor)，即是通常意义的用户和网友，是平台的主体之一、可以变换不同的身份，例如消费者、潜在消费者、寻找合作商、上下游、寻找商机的个人和企业代表。通常浏览者在注册登录后可以获得比游客身份更多的权限和功能。"/>
